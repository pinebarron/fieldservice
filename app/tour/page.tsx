...
const TOUR_SECTIONS = [
  {
    ...
    subtitle: 'See your entire week at a glance',
    description: 'Drag-and-drop calendar to schedule jobs. Assign technicians, set times, and manage your crew\'s workload — all from one screen.',
    features: [
    ...
    screenshotDesktop: '/screenshots/calendar-desktop.png',
    screenshotMobile: '/screenshots/calendar-mobile.png',
  ...
  },
  {
    ...
    subtitle: 'Your crew knows exactly what to do',
    description: 'Technicians see their jobs for the day, tap to check in, and capture everything on-site. No confusion, no phone calls asking "where do I go next?"',
    features: [
  ...
  {
    id: 'gps-photos',
    title: 'GPS-Verified Photos',
    subtitle: 'Proof your crew was on-site',
    description: 'Every photo is tagged with GPS coordinates and timestamp. Verify your technician was at the job site, not down the street. Resolve disputes with data, not arguments.',
    features: [
      'Automatic GPS tagging',
      'Timestamp on every photo',
      'Before/during/after categories',
      'Location verification vs job site',
    ],
    screenshotDesktop: '/screenshots/photos-desktop.png',
    screenshotMobile: '/screenshots/photos-mobile.png',
  ...
  {
    id: 'forms',
    title: 'Custom Forms & Signatures',
    subtitle: 'Digitize your paperwork',
    description: 'Build custom inspection checklists, site surveys, and completion forms. Capture customer signatures on-site. No more paper shuffling or lost documents.',
    features: [
      'Drag-and-drop form builder',
      'Photo fields with GPS',
  ...
  {
    id: 'feedback',
    title: 'Customer Scorecards',
    subtitle: 'Know how your team is doing',
    description: 'Automatically send feedback requests after job completion. Customers rate quality, professionalism, and timeliness. Build your reputation with real data.',
    features: [
    ...
    screenshotDesktop: '/screenshots/feedback-desktop.png',
    screenshotMobile: '/screenshots/feedback-mobile.png',
    iconClass: 'fa-star',
    reversed: false,
  },
  {
